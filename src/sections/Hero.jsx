    ...
    <section id="top" className="relative h-screen min-h-[680px] w-full overflow-hidden">
      {FEATURED.map((p, idx) => (
        <Photo
          ...
          style={{ opacity: idx === i ? 1 : 0, transform: 'scale(1.04)' }}
        />
      ))}
      ...
      <div className="relative z-10 h-full max-w-[1400px] mx-auto px-6 md:px-10 flex flex-col">
        <div className="pt-28 md:pt-32 flex items-center gap-4">
        ...
        <div className="mt-auto mb-10 md:mb-14 grid md:grid-cols-12 gap-8 items-end">
          <div className="md:col-span-8">
            <h1 className="font-display font-extrabold leading-[.92] text-[15vw] md:text-[8.5vw] tracking-tight">
              Form rooted<br /><span className="text-clay">in place.</span>
            </h1>
          </div>
